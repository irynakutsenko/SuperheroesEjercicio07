...
let fechaNac = prompt("¿Cual es tu fecha de nacimiento?");
console.log(fechaNac);
fechaNac = fechaNac[fechaNac.length - 1]

let primeraletraNombre = letraNombre[nombre[0]]["masculino"];
let ultimaletraApellido = letraApellido[apellido[apellido.length - 1]]["femenino"];
let primerNum = fechaNacimiento[parseInt(fechaNac)]["masculino"];

console.log(primeraletraNombre + " " + ultimaletraApellido + " " + primerNum);